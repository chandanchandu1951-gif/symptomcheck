const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-d2jsZBu1.js","assets/proxy-C5uP9_Ji.js","assets/triangle-alert-BWw-AbwS.js","assets/search-KZjb3d14.js","assets/Assess-Bh4gpjGP.js","assets/badge-BgwKzHjo.js","assets/index-ncL38psA.js","assets/index-BaTgAj1j.js","assets/Interview-BV7142dP.js","assets/Results-ZONiHME6.js"])))=>i.map(i=>d[i]);
...
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-card sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-5xl mx-auto px-4 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          "data-ocid": "nav-logo",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-xs group-hover:shadow-card transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-4 h-4 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-semibold text-xl text-foreground tracking-tight", children: [
              "Symptom",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Check" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-1", "data-ocid": "nav-links", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-background", "data-ocid": "main-content", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        className: "bg-card border-t border-border mt-auto",
        "data-ocid": "footer",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-5xl mx-auto px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-3.5 h-3.5 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SymptomCheck — for informational purposes only. Always consult a qualified healthcare provider." })
          ] }),
...
const AssessmentContext = reactExports.createContext(null);
function AssessmentProvider({
  children
}) {
  const [state, setState] = reactExports.useState(initialState);
  const setDemographics = (demographics) => setState((prev) => ({ ...prev, demographics }));
  const addSymptom = (symptom) => setState((prev) => ({
    ...prev,
    selectedSymptoms: prev.selectedSymptoms.some((s) => s.id === symptom.id) ? prev.selectedSymptoms : [...prev.selectedSymptoms, symptom]
  }));
  const removeSymptom = (symptomId) => setState((prev) => ({
    ...prev,
    selectedSymptoms: prev.selectedSymptoms.filter((s) => s.id !== symptomId)
  }));
  const setFollowUpQuestions = (followUpQuestions) => setState((prev) => ({ ...prev, followUpQuestions }));
  const setAnswer = (answer) => setState((prev) => ({
    ...prev,
    answers: [
  ...
  const setCurrentStep = (currentStep) => setState((prev) => ({ ...prev, currentStep }));
...
function useAssessment() {
  const ctx = reactExports.useContext(AssessmentContext);
  if (!ctx)
    throw new Error("useAssessment must be used within AssessmentProvider");
  return ctx;
}
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-d2jsZBu1.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const AssessPage = reactExports.lazy(() => __vitePreload(() => import("./Assess-Bh4gpjGP.js"), true ? __vite__mapDeps([4,5,1,6,3,7]) : void 0));
const InterviewPage = reactExports.lazy(() => __vitePreload(() => import("./Interview-BV7142dP.js"), true ? __vite__mapDeps([8,5,1,7]) : void 0));
const ResultsPage = reactExports.lazy(() => __vitePreload(() => import("./Results-ZONiHME6.js"), true ? __vite__mapDeps([9,1,6,2,5]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-3xl mx-auto px-4 py-16 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-64 mx-auto" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-96 mx-auto" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full mt-8" })
  ] });
}
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AssessmentProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) })
});
...
const assessRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/assess",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AssessPage, {})
});
const interviewRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/interview",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(InterviewPage, {})
});
const resultsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/results",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsPage, {})
});
